          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="mt-5 md:mt-0 md:ml-12">
              ...
              <ul className="space-y-4">
                <li>
                  <Link href="/graphicdesigning" className="text-[#a4a097] hover:text-white transition-colors">
                    Home
                  </Link>
                </li>
                <li>
                  <Link href="/graphicdesigning/about-us" className="text-[#a4a097] hover:text-white transition-colors">
                    About Us
                  </Link>
                </li>
                <li>
                  <Link href="/graphicdesigning/testimonials"
                    className="text-[#a4a097] hover:text-white transition-colors">
                    Testimonials
                  </Link>
                </li>
                <li>
                  <Link href="/graphicdesigning/contact" className="text-[#a4a097] hover:text-white transition-colors">
                    Contact Us
                  </Link>
                </li>
              </ul>
